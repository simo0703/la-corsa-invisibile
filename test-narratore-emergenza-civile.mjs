// Test locale: node test-narratore-emergenza-civile.mjs
//
// Verifica il caricatore (narratore-corsa-invisibile-loader.js) e il
// contenuto vero per il Nodo Temporale "emergenza-civile"
// (narratore-emergenza-civile.md), non il motore generico (quello è
// testato a parte in test-narratore-simulato.mjs). Stesso schema di
// test-narratore-1915-carso-piave.mjs, sul contenuto di questo nodo.
//
...
// disponibile normalmente. narratore-emergenza-civile.js (il file che il
...
// disco, invece di importare narratore-emergenza-civile.js (che sotto Node
...
const percorsoMd = path.join(__dirname, "src", "lib", "narratore-emergenza-civile.md");
...
verifica(
  ...
  apertura1 &&
    ...
    apertura1.testo === "Non si alza la voce, non serve: bastano le parole giuste, dette con calma."
);
