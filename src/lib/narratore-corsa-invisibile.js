// Pool di contenuto del Cronista per il nodo "1836-torino", pronto per
// essere passato a componiNarrazione() (src/lib/narratore-simulato.js).
//
// Il contenuto vero vive in narratore-corsa-invisibile.md (tabelle
...
// filesystem a runtime, quindi il .md non può essere letto con
// fs.readFile in esecuzione — l'import qui sotto viene invece risolto da
// Wrangler in fase di build (regola [[rules]] in wrangler.toml: i file
// .md vengono incorporati come stringa nel bundle, non letti da disco a
// runtime).
//
...
// direttamente. Vedi test-narratore-corsa-invisibile.mjs.
import testoGrezzo from "./narratore-corsa-invisibile.md";
