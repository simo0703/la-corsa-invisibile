// Test locale: node test-narratore-missione-moderna.mjs
//
// Verifica il caricatore (narratore-corsa-invisibile-loader.js) e il
// contenuto vero per il Nodo Temporale "missione-moderna"
// (narratore-missione-moderna.md), non il motore generico (quello è
// testato a parte in test-narratore-simulato.mjs). Stesso schema di
// test-narratore-emergenza-civile.mjs, sul contenuto di questo nodo.
//
...
// disponibile normalmente. narratore-missione-moderna.js (il file che il
...
// disco, invece di importare narratore-missione-moderna.js (che sotto Node
...
const percorsoMd = path.join(__dirname, "src", "lib", "narratore-missione-moderna.md");
...
verifica(
  ...
  apertura1 &&
    ...
    apertura1.testo === "Non un muscolo si tende, non uno sguardo si abbassa: la provocazione scivola via senza trovare presa."
);
